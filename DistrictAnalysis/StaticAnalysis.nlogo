...
;creation of real network with agents, to make calculation on it
;;exported in utility file
  ...
  foreach gis:feature-list-of tram-layer-data [
    foreach gis:vertex-lists-of ? [
      ...
      create-stations 1 [
        ...
        ifelse current-station != nobody [create-rail-with current-station [set thickness 0.4 set color red]][set target-station self]
...
;to-report distance-to-transportation
;  
;  let res 0
;  let v1 self
;  
...
;  
;  ask v1 [
;    let nearest-station first sort-on [to-station myself] stations
;    let target first sort-on [distance nearest-station] vertexes
...
;    ask vertexes [set d distance-to-transportation]
;    
;    let mi min [d] of vertexes
;    let ma max [d] of vertexes
;    ask patches with [count vertexes-on self > 0][
;      let dd [d] of one-of vertexes-on self
;      set pcolor scale-color red dd (mi + 30) (ma - 30)
;    ]
;    
;end
